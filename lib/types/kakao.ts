/**
 * Type Definitions for KakaoTalk Chatbot Integration
 * Migrated from backend/src/types/index.ts for Next.js API routes
 */

// ============================================
// KakaoTalk Webhook Types
// ============================================
...
export interface PdfUrlsConfig {
  schedule_pdfs: PdfAttachment[];
  policy_pdfs: PdfAttachment[];
}
...
// ============================================
// KakaoTalk Configuration Constants
// ============================================
...
export const VERIFICATION_CODE_PATTERN = /([A-Z]{3,4}-[A-Z0-9]{3,5}-[A-Z0-9]{3,5}(?:-[A-Z0-9]{3,5})?)/;

// Employee RAG query prefix
export const EMPLOYEE_RAG_PREFIX = '/';
