...
- 권한 수준: {{clearance_level}}`,
    ...
    modelConfig: { model: 'gemini-2.0-flash', temperature: 0.3, maxOutputTokens: 2048 },
    isDefault: true,
    isActive: true,
  },
  {
...
최적화된 검색 쿼리만 출력하세요.`,
    ...
    modelConfig: { model: 'gemini-2.0-flash', temperature: 0.1, maxOutputTokens: 256 },
    isDefault: true,
    isActive: true,
  },
  {
...
답변:`,
    ...
    modelConfig: { model: 'gemini-2.0-flash', temperature: 0.7, maxOutputTokens: 1024 },
    isDefault: true,
    isActive: true,
  },
  {
...
질문을 입력해 주세요!`,
    ...
    modelConfig: { model: 'gemini-2.0-flash', temperature: 0.5, maxOutputTokens: 256 },
    isDefault: true,
    isActive: true,
  },
  {
...
오류 코드: {{error_code}}`,
    ...
    modelConfig: { model: 'gemini-2.0-flash', temperature: 0.3, maxOutputTokens: 256 },
    isDefault: true,
    isActive: true,
  },
];
